...
export interface I18nOptions {
  /**
   * The locale, for example 'en-GB'.
   */
  locale?: string

  /**
   * The locale definitions. The key is the locale, for example 'en-GB', and the value is an object with strings. Of this object the key is the string code and the value the actual string.
   */
  locales?: Record<string, Record<string, string>>

  /**
   * The timezone identifier, for example 'Europe/London'.
   */
  timeZone?: string
}
...
export class I18n {
  ...
  /**
   * Creates a singleton I18n helper. Only used in the browser.
   *
   ...
   *
   * Looks up the value in the locale definition, using the value as a code. If the code is not found, the value is used as-is.
   *
