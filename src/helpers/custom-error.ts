...
export class CustomError extends Error {
   ...
   * 3. If error is an Error, ErrorEvent of DOMEXception, its message will be passed to the constructor and the error will be passed as a cause.
   * 4. If error is primitive it will be stringified and passed to the constructor as the message. If the message if undefined or null a default message will be passed to the constructor.
   ...
   * @param options the extra flavour
   */
